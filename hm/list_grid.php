...
laydate({
    ...
    max: laydate.now(+1) //+1代表明天，+2代表后天，以此类推
      ...
      <div class="midd_13">
        ...
        <a href="list_grid.html"><img src="images/8_05.png"><br><span>网格</span></a>
        <a href="list_list.html"><img src="images/7_10.png"><br>列表</a>
        </div>
  	  <div class="clear"></div>
      </div>
      ...
      <div class="row">
        <div class="col-md-4 animate-box"> <a href="list.html" class="item-grid text-center">
          <div class="image1" style="background-image: url(images/image_1.png)"><div class="midd_16">推荐</div></div>
          <div class="v-align">
            <div class="v-align-middle">
              <h3 class="title">新宿民宿</h3>
              <h5 class="category">这是一家家庭旅馆，很有情调。餐厅设在室外，很不错的位置，周四还会有传统的巴勒斯坦音乐。非常有意思，推荐大家</h5>
            </div>
          </div>
          </a> </div>
        <div class="col-md-4 animate-box"> <a href="list.html" class="item-grid text-center">
          <div class="image1" style="background-image: url(images/image_1.png)"><div class="midd_17">折扣</div></div>
          <div class="v-align">
            <div class="v-align-middle">
              <h3 class="title">涩谷民宿</h3>
              <h5 class="category">这是一家家庭旅馆，很有情调。餐厅设在室外，很不错的位置，周四还会有传统的巴勒斯坦音乐。非常有意思，推荐大家</h5>
            </div>
          </div>
          </a> </div>
        <div class="col-md-4 animate-box"> <a href="list.html" class="item-grid text-center">
          <div class="image1" style="background-image: url(images/image_1.png)"><div class="midd_16">推荐</div><div class="midd_17">折扣</div></div>
          <div class="v-align">
            <div class="v-align-middle">
              <h3 class="title">东京酒店</h3>
              <h5 class="category">这是一家家庭旅馆，很有情调。餐厅设在室外，很不错的位置，周四还会有传统的巴勒斯坦音乐。非常有意思，推荐大家</h5>
            </div>
          </div>
          </a> </div>
        <div class="col-md-4 animate-box"> <a href="list.html" class="item-grid text-center">
          <div class="image1" style="background-image: url(images/image_1.png)"></div>
          <div class="v-align">
            <div class="v-align-middle">
              <h3 class="title">东京酒店</h3>
              <h5 class="category">这是一家家庭旅馆，很有情调。餐厅设在室外，很不错的位置，周四还会有传统的巴勒斯坦音乐。非常有意思，推荐大家</h5>
