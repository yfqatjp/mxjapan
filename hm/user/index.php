    ...
    <div class="header-inner">
      ...
      <nav role="navigation" class="navshow">
        <ul>
          ...
          <li class="cta1"><a href="user.html">进入个人中心</a></li>
        </ul>
      </nav>
    </div>
  </div>
...
<div class="midd_auto user">
  ...
  <div class="user_1">
    ...
    <div class="user_3"><a href="2-2txsz.html"><img src="../images/user_12.jpg"></a><span><a href="2-1grxx.html">小鱼儿</a></span></div>
    <ul>
      <li>
        <span>订单详细</span>
        <a href="1-1jddd.html">酒店订单</a>
        <a href="1-2bcdd.html">包车订单</a>
      </li>
      <li>
        <span>个人信息</span>
        <a href="2-1grxx.html">个人信息</a>
        <a href="2-2txsz.html">头像设置</a>
        <a href="2-3mmxx.html">密码修改</a>
      </li>
      <li>
        <span>其他信息</span>
        <a href="3-1nbxxk.html">内部信息库</a>
        <a href="3-2cysq.html">车友申请</a>
      </li>
    </ul>
    <div class="sehun_12">
      ...
      <div id="pt1" class="sehun_3">
        ...
        <div style="display:none;" id="pt2" class="sehun_5">
          ...
          <a id="s2" href="1-1jddd.html">订单详细</a>
          <a id="s3" href="2-1grxx.html">个人信息</a>
          <a id="s4" href="3-1nbxxk.html">其他信息</a>
        </div>
      </div>
    <div class="clear"></div>
    </div>
  ...
  <div class="user_4">
    <div class="user_5">
      <a href="1-1jddd.html" class="user_6" style="margin-left:0;">酒店订单</a>
      <a href="1-2bcdd.html" class="user_7">包车订单</a>
      <a href="2-1grxx.html" class="user_8" style="margin-left:0;">个人信息</a>
      <a href="2-2txsz.html" class="user_9">头像设置</a>
    <div class="clear"></div>
    </div>
    ...
    <div class="user_10"> <a href="3-1nbxxkxx.html">
      ...
      <div class="user_11">
        ...
        <h3>面对今年冬天以来最为严重的区域性重污染天气，北京、天津、河北等地的数十个城市拉响了“警报”，142万平方公里国土遭“十面霾伏”。面对今年冬天以来最为严重的区域性重污染天气，北京、天津、河北等地的数十个城市拉响了“警报”，142万平方公里国土遭“十面霾伏”。</h3>
