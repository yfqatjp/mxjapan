                            ...
                            <div class="row">
                                <div class="col-xs-6">
                                    <h3>
                                        <?php
                                        echo $texts['TOTAL'];
                                        if($_SESSION['book']['vat_total'] > 0) echo " ".$texts['INCL_VAT']; ?>
                                    </h3>
                                    
                                    <?php if($_SESSION['book']['vat_total'] > 0) echo $texts['VAT_AMOUNT']; ?>
                                </div>
                                <div class="col-xs-6 lead text-right">
                                    <span id="total_booking">
                                        ...
                                        <?php
                                        if($_SESSION['book']['vat_total'] > 0){ ?>
                                            <small>
                                                <?php echo formatPrice($_SESSION['book']['vat_total']*CURRENCY_RATE); ?>
                                            </small>
                                            <?php
                                        } ?>
                                    </span>
